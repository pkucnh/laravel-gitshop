            ...
            <div class="col-12">
              <div class="card mt-2">
                <div class="card-header bg-dark">
                  <h3 style="text-align: center">QUẢN LÝ NHÂN SỰ</h3>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                        @foreach($data as $row)
                          <tr>
                            ...
                            <td><a href="{{url('/user/update')}}/{{$row->id}}" class="btn btn-warning">Cập nhật</a></td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card-body">
                                                    <h3 class="card-title mb-3" style="font-weight: bold;"></h3>
                                                    <img class="card-img-top" onerror="this.src='{{asset('shop/images/home/defauld.jpg')}}'" src="{{asset('user/images')}}/{{$row->img}}" style="height: 400px; width:400px; display:block;">                                                  
                                                    <ul class="list">
