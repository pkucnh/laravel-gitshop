        ...
        <div class="col-12">
          <div class="card mt-2">
            <div class="card-header bg-dark">
              <h3 style="text-align: center">QUẢN LÝ DANH MỤC</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach($menu as $row)
                          <tr>
                            ...
                            <td>
                              @if ($row->anhien == 1)
                                <p class="text-access">Hiện</p>
                              @else
                                <p class="text-access">Ẩn</p>
                          @endif
                            </td>
                            <td><a href="{{url('/menu/update')}}/{{$row->id}}" class="btn btn-warning">Cập nhật</a></td>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="card-body">
                                                        <h3 class="card-title mb-3" style="font-weight: bold;"></h3>
                                                         Bạn có chắc chắn muốn xóa? <a href="{{url('/menu/delete')}}/{{$row->id}}"  class="btn btn-danger">Xóa</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
